...
function scene:createScene( event )
	...
	local timeRecord = game2settings.highscore
	mute = settings.mute
	...
	local titel = display.newText( "Time Attack", display.contentWidth, display.contentHeight, native.systemFont, 50 )
	...
	startText.x = display.contentWidth * 0.14
	startText.y = display.contentHeight * 0.25
	startText:setTextColor( 150, 150, 150 )
	screenGroup:insert( startText )
	
	local infoText = display.newText( "Get as much points as possible", display.contentWidth, display.contentHeight, native.systemFont, 15 )
	...
	local infoText2 = display.newText( "before the time runs out!", display.contentWidth, display.contentHeight, native.systemFont, 15 )
	...
	local scoreToBeat = display.newText("Score to beat: 130 points", display.contentWidth, display.contentHeight, native.systemFont, 25 )
