...
function scene:createScene( event )
	...
	local titel = display.newText( "Classic", display.contentWidth, display.contentHeight, native.systemFont, 50 )
	...
	local startText = display.newText( "Stay alive and get as much", display.contentWidth, display.contentHeight, native.systemFont, 15 )
	startText:setReferencePoint( display.TopLeftReferencePoint )
	startText.x = display.contentWidth * 0.08
	startText.y = display.contentHeight * 0.44
	startText:setTextColor( 150, 150, 150 )
	screenGroup:insert( startText )
	
	local startText = display.newText( "points as possible!", display.contentWidth, display.contentHeight, native.systemFont, 15 )
	startText:setReferencePoint( display.TopLeftReferencePoint )
	startText.x = display.contentWidth * 0.08
	startText.y = display.contentHeight * 0.51
	startText:setTextColor( 150, 150, 150 )
	screenGroup:insert( startText )
